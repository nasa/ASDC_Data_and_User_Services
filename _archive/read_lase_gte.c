...
* ALGORITHM: None.                                                      *
*                                                                       *
* INVOCATION:    read_lase_gte <datafilename>                               *
*      WHERE:                                                           *
...
*		format							*
* 10/16/2002 -  Changed the name from read_lase.c to read_lase_gte.c   	*
*               so it can be used with several data sets.               *
************************************************************************/
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
