...
*/ 
   ...
   for (i=0;i<atoi(nlon);i++) {
     printf("\n\n     Longitude           Latitude");
     if (atoi(id)==232) 
       printf("           Mean Vertical Velocity (Pa/s)\n");
     else 
       {printf(" Error in Identification field\n");
        exit(1); }
     printf("---------------------------------------------------------------\n");
...
banner(argc)
{
  ...
  printf("**********************************************************\n\n");
  printf("  FIRE ASTEX Meanw from ECMWF READ PROGRAM \n\n");
  printf("  Version 1.0                                  July 1995 \n\n");
  printf("  This program reads the Meanw Data generated in June 1992. The\n");
