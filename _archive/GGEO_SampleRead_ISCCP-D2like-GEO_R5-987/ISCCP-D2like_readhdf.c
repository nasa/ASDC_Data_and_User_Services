 ...
 *******************************************************************************
     ...
     HDF_File = "CER_ISCCP-D2like-GEO_DAY_Sample_R5V3"; 
*/
/* ===========================================================================
...
fprintf ( stderr, "came to read Number of Observation Hours\n");
     sds_name    = "Number Of Observations - Cumulus - MH";
           ...
           for (hr=0; hr<sds_dims[0]; hr++)
             {
              ...
              printf ("\nHour Box %i\n",hr+1);
              printf ("Number Of Observations - Cumulus - MH = %i\n",(int) hour_box[indx]);
             }
          }
 ...
 *******************************************************************************
*/
    sds_name = "Total Cloud Fraction - Deep Convective - MH";
     get_sds_dims(HDF_File,sds_name,&rank,sds_dims,&type);
     sds_rank = rank;
     sds_type = type;
     sds_edge[0] = sds_dims[0]; 
           ...
           for (hr=0; hr<sds_dims[0]; hr++)
             {
              ...
              printf ("\nHour Box %i\n",hr+1);
              printf ("Total Cloud Fraction - Deep Convective - MH  = %f\n",*((float32 *)cloud_frac+indx));
             }
          }
 ...
 *******************************************************************************
*/
     sds_name    = "Monthly Total Number Of Observations - Cumulus - M";
     get_sds_dims(HDF_File,sds_name,&rank,sds_dims,&type);
     sds_rank = rank;
     sds_type = type;
     sds_edge[0] = sds_dims[0];
           ...
           for (hr=0; hr<sds_dims[0]; hr++)
             {
              ...
              printf ("\nHour Box %i\n",hr+1);
              printf ("Monthly Total Number Of Observations - Cumulus - M  = %f\n",
 ...
 *******************************************************************************
*/
    sds_name = "Total Cloud for all Cloud Types - M";
     get_sds_dims(HDF_File,sds_name,&rank,sds_dims,&type);
     sds_rank = rank;
     sds_type = type;
    sds_rank = rank;
           ...
           for (hr=0; hr<sds_dims[0]; hr++)
             {
              ...
              printf ("\nHour Box %i\n",hr+1);
              printf ("Total Cloud for all Cloud Types - M = %f\n",
                   *((float32 *)sds_data+indx));
