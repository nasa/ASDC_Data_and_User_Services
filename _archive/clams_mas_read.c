...
/****************************************************************************
*                                                                           *
* FILE: clams_mas_read.c                                                    *
* Version: 1.0                                                              *
* AUTHOR:  Langley DAAC user services                                       *
*   note:                                                                   *
...
*                                                                           *
*   December 1997: VALBUFSIZ increased to 16384                             *
*                  NVARS increased to 44                                    *
*                                                                           *
* PURPOSE/DESCRIPTION:                                                      *
*   The purpose of this program is to produce a general read program 	    *
...
*   be used to control the program in a batch environment.                  * 
...
fprintf(out,"  If not please change NVARS to number shown and remake program\n");
      exit(1);
    }
...
/********  let user select variables to print out ************/
	...
	for (varid = 0; varid < nvars; varid++) {
	     ...
	     * been written.
	     */
	    if (var[varid].ndims == 0
		|| var[varid].dims[0] != xdimid
		|| dims[xdimid].size != 0) {
...
char *argv[];
{
    ...
    printf("*                                                               *\n");
    printf("*                                                               *\n");
    printf("*                  CLAMS_ER2_MAS Read Software                  *\n");
    printf("*                                                               *\n");
    printf("*  Version: 1.0                                                 *\n");
    printf("*                                                               *\n");
    printf("*  Date:    May 2, 2002                                         *\n");
    printf("*                                                               *\n");
    ...
    printf("*                                                               *\n");
    printf("*****************************************************************\n");
    printf("This program reads CLAMS_ER2_MAS netCDF data.\n");
