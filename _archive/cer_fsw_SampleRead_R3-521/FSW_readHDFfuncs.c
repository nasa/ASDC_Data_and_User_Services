                ...
                
{
	...
	int32		order_count[MAX_VDATA_FIELDS];
	int32		total_order_count;
...
---------------------------------------------------------------
*/
void     get_sds_dims_by_index(char *filename, int32 index,  char *data_name,
         int32 *output_rank, int32 *output_dimensions, int32 *output_number_type)
{
        ...
        */
        ...
        int32           sds_id;
        int32           status;
        char            temp_name[MAX_CHAR_LENGTH];
        ...
        */
        ...
        /*      index=SDnametoindex(sd_id,data_name);*/
        sds_id=SDselect(sd_id,index);
        status=SDgetinfo(sds_id, temp_name,&rank,dimsizes,&number_type,&nattrs);
        strcpy(data_name,temp_name);
        *output_rank=rank;
        *output_number_type=number_type;
        for (i=0; i<rank; i++)
        {
...
---------------------------------------------------------------
        read_sds_by_index
---------------------------------------------------------------*/
int32   read_sds_by_index(char *filename, int32 index,  char *data_name,int32 rank,
                 int32 number_type, int32 *start, int32 *stride,
                 int32 *edge, void *sds_data)
